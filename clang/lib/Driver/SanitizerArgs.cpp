...
static const SanitizerMask RequiresPIE =
    SanitizerKind::DataFlow | SanitizerKind::Dummy | SanitizerKind::HWAddress | SanitizerKind::Scudo;
static const SanitizerMask NeedsUnwindTables =
    SanitizerKind::Address | SanitizerKind::Dummy | SanitizerKind::HWAddress | SanitizerKind::Thread |
    SanitizerKind::Memory | SanitizerKind::DataFlow;
static const SanitizerMask SupportsCoverage =
    SanitizerKind::Address | SanitizerKind::Dummy | SanitizerKind::HWAddress |
...
static void addDefaultBlacklists(const Driver &D, SanitizerMask Kinds,
  ...
  struct Blacklist {
    const char *File;
    SanitizerMask Mask;
  } Blacklists[] = {{"dummysan_blacklist.txt", SanitizerKind::Dummy},
