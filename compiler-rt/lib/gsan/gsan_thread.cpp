...
ThreadContextGsanBase::ThreadContextGsanBase(int tid)
    : ThreadContextBase(tid) {}

void ThreadContextGsanBase::OnFinished() {
...
void ThreadContextGsanBase::ThreadStart(u32 tid, tid_t os_id,
