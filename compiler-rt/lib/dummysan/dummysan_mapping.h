...
///
/// \file
/// This file is a part of DummySanitizer and defines memory mapping.
///
//===----------------------------------------------------------------------===//

#ifndef DUMMYSAN_MAPPING_H
#define DUMMYSAN_MAPPING_H
...
inline uptr ShadowToMem(uptr shadow_addr) {
  return (shadow_addr - __dummysan_shadow_memory_dynamic_address) << kShadowScale;
}
