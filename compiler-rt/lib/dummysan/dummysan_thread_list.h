...
// DummysanThreadList is a registry for live threads, as well as an allocator for
// DummysanThread objects and their stack history ring buffers. There are
...
class DummysanThreadList {
 public:
  DummysanThreadList(uptr storage, uptr size)
...
DummysanThreadList &dummysanThreadList();
