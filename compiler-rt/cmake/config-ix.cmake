...
set(ALL_SIMPLESAN_SUPPORTED_ARCH ${ALL_SANITIZER_COMMON_SUPPORTED_ARCH})
...
if(APPLE)
  ...
  list_intersect(SIMPLESAN_SUPPORTED_ARCH
    ALL_SIMPLESAN_SUPPORTED_ARCH
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(SIMPLESAN_SUPPORTED_ARCH ${ALL_SIMPLESAN_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS simplesan;asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SIMPLESAN_SUPPORTED_ARCH)
  set(COMPILER_RT_HAS_SIMPLESAN TRUE)
else()
  set(COMPILER_RT_HAS_SIMPLESAN FALSE)
endif()
